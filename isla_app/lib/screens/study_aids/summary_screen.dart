...
class _SummaryScreenState extends State<SummaryScreen> {
  ...
  /// Which AI provider actually produced the summary (set after generation).
  String _provider = 'Groq AI';
  ...
  Future<void> _generate() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _summary = result;
          _provider = _service.lastProvider;
          _isGenerating = false;
        });
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      'Summary Generated by $_provider',
